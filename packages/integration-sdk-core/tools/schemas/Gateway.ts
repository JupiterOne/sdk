...
export type Gateway = Static<typeof Gateway>;
export const Gateway = Type.Object(
  {
    _class: OneOf(
      [
    ...
    function: Type.Array(
      Type.Union([
        ...
        Type.Literal('content-filtering'),
        Type.Literal('content-distribution'),
        Type.Literal('load-balancing'),
        Type.Literal('firewall'),
        Type.Literal('ssl-termination'),
        Type.Literal('reverse-proxy'),
        Type.Literal('remote-access-gateway'),
        Type.Literal('application-protection'),
        Type.Literal('intrusion-detection'),
        Type.Literal('intrusion-prevention'),
        Type.Literal('mail-filtering'),
        Type.Literal('malware-protection'),
        Type.Literal('other'),
      ]),
