...
export const Host = Type.Object(
  {
    ...
    fqdn: Type.Optional(
      Type.Union(
        [Type.String(), Type.Array(Type.String(), { uniqueItems: true })],
    ...
    ipAddress: Type.Optional(
      Type.Union(
        [
          ...
          Type.Array(Type.String({ format: 'ip' }), { uniqueItems: true }),
          Type.Array(Type.String({ format: 'ipCidr' }), { uniqueItems: true }),
        ],
        {
          description:
    ...
    privateDnsName: Type.Optional(
      Type.String({ description: 'The private DNS name', format: 'hostname' }),
    ),
    privateIpAddress: Type.Optional(
      Type.Union(
        [
          Type.String({ format: 'ip' }),
          Type.Array(Type.String({ format: 'ip' }), { uniqueItems: true }),
    ...
    publicDnsName: Type.Optional(
      Type.String({ description: 'The public DNS name', format: 'hostname' }),
    ),
    publicIpAddress: Type.Optional(
      Type.Union(
        [
          Type.String({ format: 'ip' }),
          Type.Array(Type.String({ format: 'ip' }), { uniqueItems: true }),
