...
export type Internet = Static<typeof Internet>;
export const Internet = Type.Object(
  {
    _class: OneOf(
      [
    ...
    CIDR: Type.Optional(
      Type.Literal('0.0.0.0/0', { description: 'The IPv4 network CIDR block' }),
    ),
    CIDRv6: Type.Optional(
      Type.Literal('::/0', { description: 'The IPv6 network CIDR block' }),
    ),
    displayName: Type.Optional(
      Type.Literal('Internet', { description: 'Display name' }),
    ),
