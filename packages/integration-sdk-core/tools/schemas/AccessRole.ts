...
export type AccessRole = Static<typeof AccessRole>;
export const AccessRole = Type.Object(
  {
    _class: OneOf(
      [
    ...
    privilegeNames: Type.Optional(
      Type.Array(Type.String(), { description: "The role's privilege names" }),
    ),
    privilegeServiceIds: Type.Optional(
      Type.Array(Type.String(), {
    ...
    superAdmin: Type.Optional(
      Type.Boolean({ description: 'Is the role an administrator role?' }),
    ),
    systemRole: Type.Optional(
      Type.Boolean({ description: 'Is this a system role?' }),
    ),
    tags: Type.Optional(
      Type.Array(Type.String(), {
