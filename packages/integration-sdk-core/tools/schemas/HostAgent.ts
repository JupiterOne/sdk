...
export type HostAgent = Static<typeof HostAgent>;
export const HostAgent = Type.Object(
  {
    _class: OneOf(
      [
    ...
    function: Type.Array(
      Type.Union([
        Type.Literal('endpoint-compliance'),
        Type.Literal('endpoint-configuration'),
        Type.Literal('endpoint-protection'),
        Type.Literal('anti-malware'),
        Type.Literal('DLP'),
        Type.Literal('FIM'),
        Type.Literal('host-firewall'),
        Type.Literal('HIDS'),
        Type.Literal('log-monitor'),
        Type.Literal('activity-monitor'),
        Type.Literal('vulnerability-detection'),
