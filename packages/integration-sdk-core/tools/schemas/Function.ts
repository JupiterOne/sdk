...
export type Function = Static<typeof Function>;
export const Function = Type.Object(
  {
    _class: OneOf(
      [
    ...
    codeHash: Type.Optional(
      Type.String({ description: 'The hash of code of this function.' }),
    ),
    codeSize: Type.Optional(
      Type.String({ description: 'The size of code of this function.' }),
    ),
    ...
    handler: Type.Optional(
      Type.String({ description: 'The handler of this function' }),
    ),
    id: Type.Optional(
    ...
    trigger: Type.Optional(
      Type.String({ description: 'What triggers this function to execute.' }),
    ),
    trust: Type.Optional(
      Type.Number({
    ...
    version: Type.Optional(
      Type.String({ description: 'The version of this function.' }),
    ),
