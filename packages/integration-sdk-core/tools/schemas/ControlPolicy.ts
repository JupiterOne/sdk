...
export type ControlPolicy = Static<typeof ControlPolicy>;
export const ControlPolicy = Type.Object(
  {
    _class: OneOf(
      [
    ...
    content: Type.Optional(
      Type.String({ description: 'Contents of the raw rules, if applicable.' }),
    ),
    ...
    rules: Type.Optional(
      Type.Array(Type.String(), { description: 'Rules of policy.' }),
    ),
