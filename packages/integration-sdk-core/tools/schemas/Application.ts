...
export type Application = Static<typeof Application>;
export const Application = Type.Object(
  {
    _class: OneOf(
      [
    ...
    devURL: Type.Optional(
      Type.String({ description: 'The Development URL', format: 'uri' }),
    ),
    ...
    productionURL: Type.Optional(
      Type.String({ description: 'The Production URL', format: 'uri' }),
    ),
    ...
    testURL: Type.Optional(
      Type.String({ description: 'The Test URL', format: 'uri' }),
    ),
    trust: Type.Optional(
      Type.Number({
