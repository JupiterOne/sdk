...
export type NetworkEndpoint = Static<typeof NetworkEndpoint>;
export const NetworkEndpoint = Type.Object(
  {
    _class: OneOf(
      [
    ...
    ipAddress: Type.Optional(
      Type.String({ description: 'The endpoint IP address', format: 'ip' }),
    ),
