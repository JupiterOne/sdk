...
export type CodeReview = Static<typeof CodeReview>;
export const CodeReview = Type.Object(
  {
    _class: OneOf(
      [
    ...
    state: Type.Optional(
      Type.String({ description: 'The state of the review.' }),
    ),
    summary: Type.Optional(
      Type.String({ description: 'The summary text of the review.' }),
    ),
    title: Type.String({ description: 'The title text of the review.' }),
