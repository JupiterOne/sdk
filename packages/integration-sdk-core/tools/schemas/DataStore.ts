...
export type DataStore = Static<typeof DataStore>;
export const DataStore = Type.Object(
  {
    _class: OneOf(
      [
    ...
    encrypted: Type.Union([Type.Boolean(), Type.Null()]),
    encryptionAlgorithm: Type.Optional(
      Type.String({
        description: 'Encryption algorithm used to encrypt the data store',
      }),
    ),
    encryptionKeyRef: Type.Optional(
      Type.String({
        description:
    ...
    encryptionRequired: Type.Optional(
      Type.Boolean({ description: 'If the data needs to be encrypted' }),
    ),
    ...
    retentionPeriodDays: Type.Optional(
      Type.Number({
