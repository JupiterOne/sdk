...
export type Domain = Static<typeof Domain>;
export const Domain = Type.Object(
  {
    ...
    abuseContactEmail: Type.Optional(
      Type.String({ description: 'Abuse contact email.' }),
    ),
    ...
    adminContactEmail: Type.Optional(
      Type.String({ description: 'Administrative contact email.' }),
    ),
    autoRenew: Type.Optional(
      Type.Boolean({
        description: 'Indicates whether auto-renewal is configured.',
      }),
    ),
    billingContactEmail: Type.Optional(
      Type.String({ description: 'Billing contact email.' }),
    ),
    ...
    contactEmails: Type.Optional(
      Type.Array(Type.String(), { description: 'List of contact emails.' }),
    ),
    ...
    nameservers: Type.Optional(
      Type.Array(Type.String(), { description: 'List of nameservers.' }),
    ),
    notes: Type.Optional(
    ...
    registrantContactEmail: Type.Optional(
      Type.String({ description: 'Registrant contact email.' }),
    ),
    ...
    registrarName: Type.Optional(
      Type.String({ description: 'Domain registrar name.' }),
    ),
    registrarUrl: Type.Optional(
      Type.String({ description: 'Domain registrar URL.' }),
    ),
    risk: Type.Optional(
      Type.Number({
    ...
    techContactEmail: Type.Optional(
      Type.String({ description: 'Technical contact email.' }),
    ),
