...
export type DataCollection = Static<typeof DataCollection>;
export const DataCollection = Type.Object(
  {
    _class: OneOf(
      [
    ...
    encrypted: Type.Optional(
      Type.Boolean({ description: 'If the data in the table is encrypted' }),
    ),
    encryptionRequired: Type.Optional(
      Type.Boolean({
