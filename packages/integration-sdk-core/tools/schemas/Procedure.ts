...
export type Procedure = Static<typeof Procedure>;
export const Procedure = Type.Object(
  {
    _class: OneOf(
      [
    ...
    author: Type.Optional(Type.String({ description: 'Author of the record' })),
    ...
    title: Type.String({ description: 'Title of the procedure' }),
