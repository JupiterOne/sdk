...
export type DomainZone = Static<typeof DomainZone>;
export const DomainZone = Type.Object(
  {
    _class: OneOf(
      [
    ...
    recordsCount: Type.Optional(
      Type.Number({ description: 'Total number of DNS records in this zone.' }),
    ),
    risk: Type.Optional(
      Type.Number({
