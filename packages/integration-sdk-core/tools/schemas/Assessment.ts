...
export type Assessment = Static<typeof Assessment>;
export const Assessment = Type.Object(
  {
    _class: OneOf(
      [
    ...
    assessor: Type.Optional(
      Type.String({ description: 'Email or name or ID of the assessor' }),
    ),
    assessors: Type.Optional(
