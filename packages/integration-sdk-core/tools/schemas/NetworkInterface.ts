...
export type NetworkInterface = Static<typeof NetworkInterface>;
export const NetworkInterface = Type.Object(
  {
    _class: OneOf(
      [
    ...
    dnsName: Type.Optional(
      Type.String({ description: 'The assigned DNS name', format: 'hostname' }),
    ),
    ...
    ipVersion: Type.Optional(
      Type.Union([Type.Literal(4), Type.Literal(6)], {
