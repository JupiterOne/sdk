...
export type CodeDeploy = Static<typeof CodeDeploy>;
export const CodeDeploy = Type.Object(
  {
    _class: OneOf(
      [
    ...
    jobName: Type.Optional(
      Type.String({ description: 'Build/deploy job name.' }),
    ),
    jobNumber: Type.Optional(
      Type.Number({ description: 'Build/deploy job number.' }),
    ),
    ...
    summary: Type.Optional(
      Type.String({ description: 'Descriptive text of the job.' }),
    ),
    target: Type.Optional(
      Type.String({ description: 'Name of the target system or environment.' }),
    ),
