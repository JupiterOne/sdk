...
export type CodeRepo = Static<typeof CodeRepo>;
export const CodeRepo = Type.Object(
  {
    _class: OneOf(
      [
    ...
    project: Type.Optional(
      Type.String({ description: 'The project that this repo belongs to.' }),
    ),
    public: Type.Optional(
      Type.Boolean({ description: 'Indicates if this is a public repo.' }),
    ),
    risk: Type.Optional(
      Type.Number({
