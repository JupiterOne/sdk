...
export type Control = Static<typeof Control>;
export const Control = Type.Object(
  {
    _class: OneOf(
      [
      ...
      OneOf(
        [
          Type.Union([
            ...
            Type.Literal('access-control'),
            Type.Literal('access-review'),
            Type.Literal('compliance'),
            Type.Literal('monitoring'),
            Type.Literal('logging'),
            Type.Literal('auditing'),
            Type.Literal('scheduling'),
            Type.Literal('configuration-audit'),
            Type.Literal('key-management'),
            Type.Literal('password-management'),
            Type.Literal('secret-management'),
            Type.Literal('config-management'),
            Type.Literal('device-management'),
            Type.Literal('patch-management'),
            Type.Literal('endpoint-management'),
            Type.Literal('endpoint-protection'),
            Type.Literal('data-protection'),
            Type.Literal('data-encryption'),
            Type.Literal('pen-test'),
            Type.Literal('bug-bounty'),
            Type.Literal('appsec'),
            Type.Literal('application-security'),
            Type.Literal('container-security'),
            Type.Literal('package-registry'),
            Type.Literal('infrastructure'),
            Type.Literal('ticketing'),
            Type.Literal('training'),
            Type.Literal('firewall'),
            Type.Literal('networking'),
            Type.Literal('wifi'),
            Type.Literal('physical-access'),
            Type.Literal('video-surveillance'),
            Type.Literal('DNS'),
            Type.Literal('VPN'),
            Type.Literal('IAM'),
            Type.Literal('SSO'),
