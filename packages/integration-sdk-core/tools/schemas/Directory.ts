...
export type Directory = Static<typeof Directory>;
export const Directory = Type.Object(
  {
    _class: OneOf(
      [
    ...
    directoryServers: Type.Optional(
      Type.Array(Type.String(), { description: 'List of directory servers.' }),
    ),
    ...
    domainControllers: Type.Optional(
      Type.Array(Type.String(), { description: 'List of domain controllers.' }),
    ),
    ...
    type: Type.Optional(
      Type.String({ description: 'Directory type.', examples: ['LDAP', 'AD'] }),
    ),
