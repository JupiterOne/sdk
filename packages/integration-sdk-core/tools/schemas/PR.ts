...
export type PR = Static<typeof PR>;
export const PR = Type.Object(
  {
    _class: OneOf(
      [
    ...
    source: Type.String({ description: 'The source branch.' }),
    state: Type.String({
      description: 'The state of the PR.',
      examples: ['open', 'merged', 'declined', 'superseded'],
    }),
    summary: Type.Optional(
      Type.String({ description: 'The summary text of the PR.' }),
    ),
    target: Type.String({ description: 'The target/destination branch.' }),
    title: Type.String({ description: 'The title text of the PR.' }),
