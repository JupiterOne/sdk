...
export type PasswordPolicy = Static<typeof PasswordPolicy>;
export const PasswordPolicy = Type.Object(
  {
    _class: OneOf(
      [
    ...
    expiryWarningDays: Type.Optional(
      Type.Number({
        description:
    ...
    minLength: Type.Optional(
      Type.Number({ description: 'Minimum password length' }),
    ),
