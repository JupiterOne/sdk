...
export type Key = Static<typeof Key>;
export const Key = Type.Object(
  {
    ...
    fingerprint: Type.Optional(
      Type.String({ description: 'The fingerprint that identifies the key' }),
    ),
    id: Type.Optional(
    ...
    material: Type.Optional(Type.String({ description: 'The key material' })),
