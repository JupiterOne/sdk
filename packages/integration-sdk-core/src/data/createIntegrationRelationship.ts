...
type MappedRelationshipOptions = {
  /**
   * The `_class` of all relationships generated by this relationship mapping.
   */
  _class: string;
...
type MappedRelationshipLiteralOptions = {
  ...
  /**
   * An optional `_key` of the relationship mapping. Generated relationships
   * will not have this `_key`, since they would not then be unique.
   *
   * @deprecated there is no utility in providing a value
   */
  _key?: string;
